...
- [ ] **S0.3** — Criar bateria completa de docs (este documento + 13 outros + 5 ADRs)
- [ ] **S0.4** — Reescrever `README.md` root com narrativa de portfólio
- [ ] **S0.5** — Adicionar CONTRIBUTING.md, LICENSE (MIT), CODE_OF_CONDUCT.md
- [ ] **S0.6** — Configurar GitHub repo: descrição, topics, homepage
